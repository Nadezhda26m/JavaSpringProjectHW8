...
VALUES
    ('Говядина', 'Мясо и мясопродукты', '12', 90, 2.83, 0, 1),
    ('Помидоры', 'Овощи', '14', 90, 1.2, 0, 1),
    ('Огурцы', 'Овощи', '14', 90, 4.5, 0, 1),
    ('Подсолнечное масло', 'Растительные масла', '14', 90, 3, 1, 1),
    ('Сыр моцарелла', 'Молоко и молочные продукты', '12', 90, 2.4, 1, 1),
